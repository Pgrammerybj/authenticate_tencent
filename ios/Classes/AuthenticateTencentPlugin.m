#import "AuthenticateTencentPlugin.h"
#import <TencentCloudHuiyanSDKFace/WBFaceVerifyCustomerService.h>

@interface AuthenticateTencentPlugin () <WBFaceVerifyCustomerServiceDelegate>

@property (nonatomic, copy) FlutterResult result;

@end

@implementation AuthenticateTencentPlugin

+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar> *)registrar {
    FlutterMethodChannel *faceChannel = [FlutterMethodChannel
        methodChannelWithName:@"com.mengtu.saywo.authenticate"
              binaryMessenger:registrar.messenger];
    AuthenticateTencentPlugin *facePlugin = [[AuthenticateTencentPlugin alloc] init];
